...
public class MartiniControllerGuiBeanInfo extends SimpleBeanInfo {

	protected static final Logger LOGGER = LoggingManager.getLoggerFor(MartiniControllerGuiBeanInfo.class.getName());

	protected final ResourceBundle resourceBundle;

	public MartiniControllerGuiBeanInfo() {
		String baseName = MartiniControllerGui.class.getName();
		resourceBundle = ResourceBundle.getBundle(baseName);
	}

	@Override
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(MartiniControllerGui.class);
