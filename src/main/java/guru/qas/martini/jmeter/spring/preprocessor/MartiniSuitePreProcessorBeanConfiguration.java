...
public class MartiniSuitePreProcessorBeanConfiguration {
	...
	@Bean
	MartiniSuitePreProcessorBean getMartiniSuitePreProcessorBean(
		AutowireCapableBeanFactory beanFactory,
		@Value("${martini.suite.preprocessor.bean.impl:#{null}}")
			Class<? extends MartiniSuitePreProcessorBean> implementation
	) {
		implementation = null == implementation ? DefaultMartiniSuitePreProcessorBean.class : implementation;
